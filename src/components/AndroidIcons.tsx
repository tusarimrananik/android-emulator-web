...
// Official Google 'G' Logo (Exact Brand Colors: Blue #4285F4, Red #EA4335, Yellow #FBBC05, Green #34A853)
...
// Google Voice Search Mic (4-color)
...
// Exact Google Play Store Icon (Triangular Play badge)
export const PlayStoreIcon = ({ className = "w-full h-full" }: { className?: string }) => (
  <svg viewBox="0 0 192 192" className={className}>
    <rect width="192" height="192" rx="44" fill="#ffffff" />
    <g transform="translate(24, 20) scale(0.28)">
      <path
...
// Exact Google Photos Pinwheel Icon
...
// Exact Android Phone App Icon (Google Phone)
export const AndroidPhoneIcon = ({ className = "w-full h-full" }: { className?: string }) => (
  <svg viewBox="0 0 192 192" className={className}>
    <rect width="192" height="192" rx="44" fill="#1E8E3E" />
    <path
      fill="#ffffff"
      d="M137.5 120.2c-5.2-1.5-10.8-1.5-16 0l-6.7 6.7c-13.3-7-23.9-17.6-31-31l6.7-6.7c1.5-5.2 1.5-10.8 0-16L78.9 44.3c-2.8-6.7-10.3-10.6-17.5-9-16.6 3.8-29.5 16.7-33.3 33.3-3.2 14-.2 28.8 8.6 40.9 14.8 20.7 34.1 40 54.8 54.8 12.1 8.7 26.8 11.8 40.9 8.6 16.6-3.8 29.5-16.7 33.3-33.3 1.6-7.2-2.3-14.7-9-17.5l-27.9-11.9z"
    />
  </svg>
);

// Exact Android Google Messages Icon (Material Blue with 3 dots)
export const AndroidMessagesIcon = ({ className = "w-full h-full" }: { className?: string }) => (
  <svg viewBox="0 0 192 192" className={className}>
    <rect width="192" height="192" rx="44" fill="#1A73E8" />
    <path
      fill="#ffffff"
      d="M48 52h96c8.8 0 16 7.2 16 16v52c0 8.8-7.2 16-16 16H82l-30 22V68c0-8.8 7.2-16 16-16z"
    />
    <circle cx="74" cy="94" r="7" fill="#1A73E8" />
    <circle cx="96" cy="94" r="7" fill="#1A73E8" />
    <circle cx="118" cy="94" r="7" fill="#1A73E8" />
  </svg>
);

// Exact Google Pixel Camera Icon
export const AndroidCameraIcon = ({ className = "w-full h-full" }: { className?: string }) => (
  <svg viewBox="0 0 192 192" className={className}>
    <rect width="192" height="192" rx="44" fill="#202124" />
    <path
      fill="#5F6368"
      d="M136 58h-16l-7-12H79l-7 12H56c-8.8 0-16 7.2-16 16v60c0 8.8 7.2 16 16 16h80c8.8 0 16-7.2 16-16V74c0-8.8-7.2-16-16-16z"
    />
    <circle cx="96" cy="104" r="30" fill="#1A73E8" />
    <circle cx="96" cy="104" r="20" fill="#202124" />
    <circle cx="96" cy="104" r="11" fill="#34A853" />
    <circle cx="132" cy="76" r="4.5" fill="#FBBC04" />
  </svg>
);

// Exact Google Settings Gear Icon
export const AndroidSettingsIcon = ({ className = "w-full h-full" }: { className?: string }) => (
  <svg viewBox="0 0 192 192" className={className}>
    <rect width="192" height="192" rx="44" fill="#5F6368" />
    ...
    />
    <circle cx="96" cy="96" r="20" fill="#5F6368" />
  </svg>
);

// Exact Google Calculator Icon (Material Cyan/Teal)
export const AndroidCalculatorIcon = ({ className = "w-full h-full" }: { className?: string }) => (
  <svg viewBox="0 0 192 192" className={className}>
    <rect width="192" height="192" rx="44" fill="#00838F" />
    <circle cx="68" cy="68" r="15" fill="#ffffff" opacity="0.3" />
    <text x="61" y="75" fill="#ffffff" fontSize="24" fontWeight="bold" fontFamily="sans-serif">÷</text>
    <circle cx="124" cy="68" r="15" fill="#ffffff" opacity="0.3" />
    <text x="117" y="75" fill="#ffffff" fontSize="24" fontWeight="bold" fontFamily="sans-serif">×</text>
    <circle cx="68" cy="124" r="15" fill="#ffffff" opacity="0.3" />
    <text x="61" y="131" fill="#ffffff" fontSize="24" fontWeight="bold" fontFamily="sans-serif">−</text>
    <circle cx="124" cy="124" r="15" fill="#FBBC04" />
    <text x="117" y="131" fill="#202124" fontSize="24" fontWeight="bold" fontFamily="sans-serif">=</text>
  </svg>
);

// Exact Google Clock Icon
export const AndroidClockIcon = ({ className = "w-full h-full" }: { className?: string }) => (
  <svg viewBox="0 0 192 192" className={className}>
    <rect width="192" height="192" rx="44" fill="#1E88E5" />
    <circle cx="96" cy="96" r="62" fill="#ffffff" />
    <circle cx="96" cy="96" r="8" fill="#1E88E5" />
    <line x1="96" y1="96" x2="96" y2="58" stroke="#1E88E5" strokeWidth="6" strokeLinecap="round" />
    <line x1="96" y1="96" x2="124" y2="96" stroke="#1E88E5" strokeWidth="6" strokeLinecap="round" />
    <line x1="96" y1="96" x2="82" y2="122" stroke="#EA4335" strokeWidth="3" strokeLinecap="round" />
  </svg>
);

// Exact Google Files Icon
export const AndroidFilesIcon = ({ className = "w-full h-full" }: { className?: string }) => (
  <svg viewBox="0 0 192 192" className={className}>
    <rect width="192" height="192" rx="44" fill="#ffffff" />
    <path
      fill="#4285F4"
      d="M44 64c0-8.8 7.2-16 16-16h32l16 16h40c8.8 0 16 7.2 16 16v48c0 8.8-7.2 16-16 16H60c-8.8 0-16-7.2-16-16V64z"
    />
    <path fill="#34A853" d="M96 112h-32v-12h32v12z" />
    <circle cx="132" cy="116" r="12" fill="#FBBC04" />
  </svg>
);

// Exact YouTube Music Icon
export const AndroidYTMusicIcon = ({ className = "w-full h-full" }: { className?: string }) => (
  <svg viewBox="0 0 192 192" className={className}>
    <rect width="192" height="192" rx="44" fill="#FF0000" />
    <circle cx="96" cy="96" r="58" fill="#202124" />
    <circle cx="96" cy="96" r="42" fill="#FF0000" />
    <circle cx="96" cy="96" r="30" fill="#202124" />
    <polygon points="86,76 116,96 86,116" fill="#ffffff" />
  </svg>
);

// Exact Google Keep Notes Icon
export const AndroidKeepIcon = ({ className = "w-full h-full" }: { className?: string }) => (
  <svg viewBox="0 0 192 192" className={className}>
    <rect width="192" height="192" rx="44" fill="#FBBC04" />
    <path
      fill="#ffffff"
      d="M60 50h72c6.6 0 12 5.4 12 12v68c0 6.6-5.4 12-12 12H60c-6.6 0-12-5.4-12-12V62c0-6.6 5.4-12 12-12z"
    />
    <circle cx="96" cy="84" r="16" fill="#F29900" />
    <path fill="#F29900" d="M90 104h12v5H90zM92 111h8v4h-8z" />
  </svg>
);

// Exact Google Play Games Icon
export const AndroidGamesIcon = ({ className = "w-full h-full" }: { className?: string }) => (
  <svg viewBox="0 0 192 192" className={className}>
    <rect width="192" height="192" rx="44" fill="#0F9D58" />
    <path
      fill="#ffffff"
...
// Official Voice Recorder Icon
export const AndroidRecorderIcon = ({ className = "w-full h-full" }: { className?: string }) => (
  <svg viewBox="0 0 192 192" className={className}>
    <rect width="192" height="192" rx="44" fill="#D93025" />
    <circle cx="96" cy="96" r="46" fill="#ffffff" opacity="0.2" />
    <path
      fill="#ffffff"
...
export const AndroidYouTubeIcon = ({ className = "w-full h-full" }: { className?: string }) => (
  <svg viewBox="0 0 192 192" className={className}>
    <rect width="192" height="192" rx="44" fill="#FF0000" />
    <polygon points="82,70 126,96 82,122" fill="#ffffff" />
  </svg>
);

// Termux Linux Terminal Icon
export const AndroidTermuxIcon = ({ className = "w-full h-full" }: { className?: string }) => (
  <svg viewBox="0 0 192 192" className={className}>
    <rect width="192" height="192" rx="44" fill="#000000" />
    <text x="44" y="114" fill="#00E676" fontSize="50" fontFamily="monospace" fontWeight="bold">&gt;_</text>
  </svg>
);

// Google Maps Icon
export const GoogleMapsIcon = ({ className = "w-full h-full" }: { className?: string }) => (
  <svg viewBox="0 0 192 192" className={className}>
    <rect width="192" height="192" rx="44" fill="#ffffff" />
    <path fill="#4285F4" d="M96 32c-26.5 0-48 21.5-48 48 0 35.5 48 80 48 80s48-44.5 48-80c0-26.5-21.5-48-48-48z" />
    <circle cx="96" cy="80" r="18" fill="#ffffff" />
    <path fill="#EA4335" d="M96 62c-9.9 0-18 8.1-18 18 0 12.8 18 32 18 32s18-19.2 18-32c0-9.9-8.1-18-18-18z" />
  </svg>
);

// Gmail Icon
export const GmailIcon = ({ className = "w-full h-full" }: { className?: string }) => (
  <svg viewBox="0 0 192 192" className={className}>
    <rect width="192" height="192" rx="44" fill="#ffffff" />
    <path fill="#4285F4" d="M48 60v72h20V88l28 20 28-20v44h20V60l-48 36L48 60z" />
    <path fill="#EA4335" d="M96 96L48 60h96l-48 36z" />
  </svg>
);
